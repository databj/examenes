        ...
        plotOptions:{
            bar:{
                ...
                var b={
                        ...
                        var a={
                            chart:{
                                ...
                                markers:{
                                    ...
                                    stroke:{curve:"straight"},
                                    fill:{opacity:0.3,},
                                    series:[{data:j(p)}],yaxis:{min:0},colors:["#F7AF17"],};
                    ...
                    {
                        var t=q(
                            new Date("19 Jan 2021").getTime(),365,{min:10,max:50});
                    var v=
                    {
                        chart:{
                        id:"chart2",
                        ...
                        toolbar:{
                            ...
                            var u={chart:{
                                ...
                                xaxis:{
                                    min:new Date("01 Jan 2021 10:00:00").getTime(),
                                    max:new Date("31 Jan 2021 10:00:00").getTime()}}},
                                ...
                                function q(C,D,B){
                                    ...
                                    while(A<D){
                                        var w=C;
                                        var E=Math.floor(Math.random()*(B.max-B.min+1))+B.min;z.push([w,E]);C+=86400000;A++}return z}});
              ...
              window.Apex={
                  chart:{
                      ...
                      xaxis:{axisTicks:{color:"#333"},
                      axisBorder:{color:"#333"}},
                      fill:{type:"gradient",
                      gradient:{gradientToColors:["#F55555","#6078ea","#6094ea"]},},
                      tooltip:{theme:"dark",x:{formatter:function(q){return moment(new Date(q)).format("HH:mm:ss")}}},
                      yaxis:{decimalsInFloat:2,opposite:true,labels:{offsetX:-10}}};
                      var e=3;
                      var d=11;function l(){
                          var q=d;return(Math.sin(q/e)*(q/e)+q/e+1)*(e*2)}
                          function f(q){return Math.floor(Math.random()*(q.max-q.min+1))+q.min}
                          function k(u,v,t){
                              var s=0;
                              var r=[];
                              while(s<v){
                                  var q=u;
                                  var w=((Math.sin(s/e)*(s/e)+s/e+1)*(e*2));r.push([q,w]);u+=300000;s++}
                                  return r}
                                  
                                  function n(r,q){
                                      var s=r+300000;return{
                                          x:s,y:Math.floor(
                                              Math.random()*(q.max-q.min+1))+q.min}}
                                              var o={
                                                  chart:{
                                                      type:"radialBar",
                                                      height:250,
                                                          ...
                                                          radialBar:{
                                                              ...
                                                              hollow:{
                                                                  ...
                                                                  track:{
                                                                      ...
                                                                      strokeWidth:"10%",
                                                                      opacity:1,margin:3,},},},
                                                                      series:[55,60],labels:["CPU","RAM"],
                                                                      legend:{show:true,position:"left",
                                                                      offsetX:0,offsetY:0,formatter:function(r,q){
                                                                          ...
                                                                          fill:{
                                                                              ...
                                                                              gradient:{
                                                                                  ...
                                                                                  window.setInterval(
                                                                                      function(){
                                                                                          d++;
                                                                                          h.updateSeries([f({min:10,max:100}),
                                                                                            f({min:10,max:100})])},3000);
                                                                                                        ...
                                                                                                        plotOptions:{
                                                                                                            bar:{
                                                                                                                ...
                                                                                                                var j=function(r){
                                                                                                                    ...
                                                                                                                    var t=u.length,s,q;
                                                                                                                    while(0!==t){
                                                                                                                        q=Math.floor(Math.random()*t);t-=1;s=u[t];u[t]=u[q];u[q]=s}
                                                                                                                        return u};
                                                                                                                ...
                                                                                                                var i={
                                                                                                                    chart:{
                                                                                                                        ...
                                                                                                                        sparkline:{enabled:true},},
                                                                                                                        stroke:{curve:"straight"},
                                                                                                                        fill:{opacity:0.3,},series:[{data:j(p)}],

$(function(){
                    ...
                    new Chart(a,{type:"line",data:{labels:["Jan","Feb","Mar","Apr","May","Jun"],
                    datasets:[{
                    label:"Sales Report",
                    ...
                    borderWidth:1,fill:true}]},
                    options:{legend:{display:true,labels:{
                        display:true,fontFamily:"IBM Plex Sans, sans-serif",fontColor:"#8392a5",}},
                        scales:{
                            yAxes:[{
                                ticks:{
                                    beginAtZero:true,
                                    fontSize:11,fontFamily:"IBM Plex Sans, sans-serif",fontColor:"#8392a5",max:25}}],
                                    xAxes:[{
                                        ticks:{
                                            beginAtZero:true,
                                            fontSize:11,fontFamily:"IBM Plex Sans, sans-serif",fontColor:"#8392a5",}}]}}});
                                            
                                            window.Apex={stroke:{width:1},markers:{size:0},tooltip:{fixed:{enabled:true,}}};
                                            var l=function(p){var s=p.slice();
                                                var r=s.length,q,o;
                                                while(0!==r){o=Math.floor(Math.random()*r);
                                                    r-=1;q=s[r];s[r]=s[o];s[o]=q}return s};
                                                    var n=[47,45,54,38,56,24,65,31,37,39,62,51,35,41,35,27,93,53,61,27,54,43,19,46];
                                                    var h={chart:{type:"area",height:60,fontFamily:"IBM Plex Sans, sans-serif",
                                                    foreColor:"#8392a5",sparkline:{enabled:true},},
                                                    stroke:{curve:"straight"},fill:{opacity:0.3,},
                                                    series:[{data:l(n)}],yaxis:{min:0},
                                                    colors:["#04CAD0"],};
                    var d={chart:{
                        type:"area",
                        height:60,
                    ...
                    var b={chart:{
                        ...
                        fill:{opacity:0.3},
                        series:[{data:l(n)}],
                        xaxis:{crosshairs:{width:1},},yaxis:{min:0},colors:["#04CAD0"],};
                    ...
                    var j={
                        chart:{
                            ...
                            series:[{data:l(n)}],
                            yaxis:{min:0},colors:["#4285F4"],};
                            var i={chart:{type:"area",
                            height:60,fontFamily:"IBM Plex Sans, sans-serif",
                            foreColor:"#8392a5",
                            sparkline:{enabled:true},},
                            stroke:{curve:"straight"},
                            fill:{opacity:0.3,},
                     ...
                     var f={chart:{
                                ...
                                fill:{opacity:0.3},
                                series:[{data:l(n)}],
                                xaxis:{crosshairs:{width:1},},yaxis:{min:0},
                                colors:["#04CAD0"],};
                    ...
                    var m={chart:{
                        ...
                        series:[{name:"Net Profit",data:[44,55,57,56,61,58]},{
                            name:"Revenue",data:[76,85,101,98,87,105]},{
                                ...
                                fill:{opacity:1},tooltip:{y:{formatter:function(o){return"$ "+o+" thousands"}}}};

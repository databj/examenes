                ...
                candlestick:{
                    colors:{
                        ...
                        series:[{
                            ...
                            var e=new ApexCharts(document.querySelector("#btcEthDashChart"),b);
                            e.render();
                            window.Apex={
                                stroke:{width:1},
                                markers:{size:0},
                                ...
                                var d=function(g){
                                    ...
                                    while(0!==i){
                                        ...
                                        j[i]=j[f];
                                        j[f]=h}return j};
                                        var a=[47,45,54,38,56,24,65,31,37,39,62,51,35,41,35,27,93,53,61,27,54,43,19,46];
                                        var c={
                                            chart:{
                                                type:"area",
                                                height:150,
                                                ...
                                                yaxis:{min:0},};
                                                var c=new ApexCharts(document.querySelector("#btcChart"),c);
                                                c.render();
                                                var c={
                                                    chart:{
                                                        type:"area",
                                                        ...
                                                        var c=new ApexCharts(document.querySelector("#ethChart"),c);
                                                        c.render();
                                                        var c={
                                                            chart:{
                                                            type:"area",
                                                            ...
                                                            var c=new ApexCharts(document.querySelector("#dashChart"),c);
                                                            c.render();
                                                            var c={
                                                                chart:{
                                                                    type:"area",
                                                                    ...
                                                                    stroke:{curve:"straight"},
                                                                    fill:{opacity:0.3},
                                                                    series:[{data:d(a)}],colors:["#E99C5E"],
                                                                    xaxis:{crosshairs:{width:1},},
                                                                    yaxis:{min:0},};
                                                                    
                                                                var c=new ApexCharts(document.querySelector("#coinState1"),c);
                                                                c.render();
                                                                var c={
                                                                    chart:{
                                                                        type:"area",
                                                                        ...
                                                                        sparkline:{
                                                                            ...
                                                                            xaxis:{
                                                                                crosshairs:{width:1},},
                                                                                yaxis:{min:0},};
                                                                                var c=new ApexCharts(document.querySelector("#coinState2"),c);
                                                                                c.render();
                                                                        var c={
                                                                            chart:{
                                                                                type:"area",
                                                                                ...
                                                                                xaxis:{crosshairs:{width:1},},
                                                                                yaxis:{min:0},};
                                                                                var c=new ApexCharts(document.querySelector("#coinState3"),c);
                                                                                c.render();
                                                                                ...
                                                                                var c={chart:{
                                                                                    ...
                                                                                    stroke:{
                                                                                        ...
                                                                                        var c=new ApexCharts(document.querySelector("#coinState4"),c);
                                                                                        c.render();
                                                                                        ...
                                                                                        var c=new ApexCharts(document.querySelector("#coinState5"),c);
                                                                                        c.render();
                                                                                        ...
                                                                                        var c=new ApexCharts(document.querySelector("#coinState6"),c);
                                                                                        c.render();
                                                                                        var c={chart:{
                                                                                            type:"area",
                                                                                            height:20,
                                                                                            ...
                                                                                            xaxis:{crosshairs:{width:1},},
                                                                                            yaxis:{min:0},};
                                                                                            var c=new ApexCharts(document.querySelector("#coinState7"),c);
                                                                                            c.render();
                                                                                        ...
                                                                                        var c={chart:{
                                                                                            ...
                                                                                            stroke:{curve:"straight"},
                                                                                            fill:{opacity:0.3},
                                                                                            series:[{data:d(a)}],colors:["#DC3545"],
                                                                                            xaxis:{crosshairs:{width:1},},
                                                                                            yaxis:{min:0},};
                                                                                            
                                                                                        var c=new ApexCharts(document.querySelector("#coinState8"),c);
                                                                                        c.render();
                                                                                        var c={chart:{
                                                                                            type:"area",
                                                                                            height:20,
                                                                                            ...
                                                                                            var c=new ApexCharts(document.querySelector("#coinState9"),c);
                                                                                            c.render();
                                                                                            var c={chart:{
                                                                                                type:"area",
                                                                                                height:20,
                                                                                                ...
                                                                                                stroke:{curve:"straight"},
                                                                                                fill:{opacity:0.3},
                                                                                                series:[{data:d(a)}],colors:["#00B297"],
                                                                                                xaxis:{crosshairs:{width:1},},
                                                                                                yaxis:{min:0},};
                                                                                                
                                                                                            var c=new ApexCharts(document.querySelector("#coinState10"),c);
                                                                                            c.render()});
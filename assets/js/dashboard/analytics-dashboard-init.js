$(function(){
                ...
                var b={
                    chart:{
                        height:350,type:"bar",fontFamily:"IBM Plex Sans, sans-serif",foreColor:"#6780B1",},
                        plotOptions:{
                            bar:{
                                horizontal:false,
                                columnWidth:"50%",},},
                                ...
                                series:[{name:"New Visitors",data:[44,55,57,56,61,58,63,60,66]},
                                {name:"Unique Visitors",data:[76,85,101,98,87,105,91,114,94]},
                                {name:"Returning Visitors",data:[35,41,36,26,45,48,52,53,41]}],
                                        ...
                                        plotOptions:{
                                            ...
                                            stroke:{
                                                ...
                                                dataLabels:{
                                                    ...
                                                    series:[
                                                        {name:"Marine Sprite",
                                                    data:[44,55,41,37,22,43,21,44,55,41,37,22,43,21,44,55,41,37,22,43,21,44,55,41,37,22,43,21,44,55,41,37,22,43,21,44,55,41,37,22,43,21]},
                                                    {name:"Striking Calf",
                                                    data:[53,32,33,52,13,43,32,53,32,33,52,13,43,32,53,32,33,52,13,43,32,53,32,33,52,13,43,32,53,32,33,52,13,43,32,53,32,33,52,13,43,32]}],
                                                    fill:{
                                                        opacity:0.7},
                                ...
                                var b={
                                    chart:{
                                        ...
                                        stacked:true,
                                        fontFamily:"IBM Plex Sans, sans-serif",
                                        foreColor:"#8392a5",toolbar:{show:false,},},
                                    ...
                                    plotOptions:{
                                        bar:{
                                            ...
                                            series:[
                                                ...
                                                fill:{opacity:1},legend:{show:false,position:"top",offsetY:0,},};

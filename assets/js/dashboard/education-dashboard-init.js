                     ...
                     data:[10,10,15,5,15,10,10,15,5,20,15]},{
                        ...
                        {opacity:[0.85,0.25,1],
                           gradient:{
                              ...
                              tooltip:{
                                 y:{
                                    formatter:function(c){return" $"+c}}},
                                    legend:{labels:{useSeriesColors:false},}};
                                    ...
                                    var a={
                                       chart:{
                                          ...
                                          type:"radar",},
                                          series:[{
                                             name:"Science",data:[80,50,30,40,100,20],},{
                                                name:"Arts",data:[20,30,40,80,20,80],},{
                                                   name:"Commerce",data:[44,76,78,13,43,10],}],
